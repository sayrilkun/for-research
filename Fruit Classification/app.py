...
def upload():
    ...
    for upload in request.files.getlist("file"):
        ...
        new_model.summary()
        test_image = image.load_img(r'C:\Users\madar\Documents\Python\Fruit Classification-20210505T045021Z-001\Fruit Classification\images\\'+filename,target_size=(64,64))
