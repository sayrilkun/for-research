...
print("\nTraining the data...\n")
training_set = train_datagen.flow_from_directory(r'C:\Users\madar\Downloads\archive\train',
                                                target_size=(64,64),
                                                batch_size=12, #Total no. of batches
                                                class_mode='categorical')

test_set = test_datagen.flow_from_directory(r'C:\Users\madar\Downloads\archive\validation',
                                            target_size=(64,64),
                                            batch_size=12,
                                            class_mode='categorical')

classifier.fit(training_set,
                         steps_per_epoch=3581, # Total training images
                         epochs = 20, # Total no. of epochs
                         validation_data = test_set,
                         validation_steps = 351) # Total testing images
